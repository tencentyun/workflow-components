...
func NewBuilder(envs map[string]string) (*Builder, error) {
	...
	if envs["FROM_IMAGE"] == "" {
		return nil, fmt.Errorf("envionment variable FROM_IMAGE is required")
	}
	b.Image = envs["FROM_IMAGE"]
	...
	b.FromHubUser = envs["FROM_HUB_USER"]
	b.FromHubToken = envs["FROM_HUB_USER"]
...
func (b *Builder) run() error {
	...
	// 从公共仓库中拉取镜像不需要login
	if b.FromHubUser != "" || b.FromHubToken != "" {
		if err := b.loginRegistry(b.hub, b.FromHubUser, b.FromHubToken); err != nil {
			return err
		}
	}
